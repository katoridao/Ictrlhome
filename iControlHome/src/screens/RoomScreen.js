  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <Text style={[styles.defaultText, { color: themeStyles.subText }]}>
          (Phòng mặc định)
        </Text>
        ...
        >
          <Text style={[styles.sectionText, { color: themeStyles.text }]}>
            Được chia sẻ
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.roomActions}>
        ...
        <TouchableOpacity onPress={onEdit}>
          <Image
            ...
            style={[styles.icon, { marginLeft: 12, tintColor: '#f52109' }]}
          />
        </TouchableOpacity>
      </View>
    </View>
