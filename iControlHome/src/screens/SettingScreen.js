      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.userEmail, { color: themeStyles.subText }]}>
...
const styles = StyleSheet.create({
  ...
  userBox: { borderRadius: 16, padding: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 24, elevation: 2 },
