    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Image source={require('../../public/img/back.png')} style={styles.backIcon} />
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  header: { height: 80, backgroundColor: '#3b9cff', borderBottomLeftRadius: 20, borderBottomRightRadius: 20, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 20 },
  backIcon: { width: 22, height: 22, tintColor: '#fff' },
  headerTitle: { color: '#fff', fontSize: 20, fontWeight: '700' },
  body: { padding: 16, paddingBottom: 40 },
  userBox: { backgroundColor: '#fff', borderRadius: 16, padding: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 24, elevation: 2 },
  avatar: { width: 50, height: 50, borderRadius: 25, marginRight: 12 },
  userName: { fontSize: 18, fontWeight: '700', color: '#333' },
  userEmail: { fontSize: 14, color: '#777' },
  badge: { backgroundColor: '#eef7ff', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, marginRight: 6 },
  ...
  sectionBox: { backgroundColor: '#fff', borderRadius: 16, marginBottom: 20, elevation: 1, overflow: 'hidden' },
